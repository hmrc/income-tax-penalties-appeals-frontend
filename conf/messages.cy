...
agentPlanned.honestyDeclaration.li.bereavement.lpp = because my client was affected by someone’s death, they were unable to make the payment due on {0} (Welsh)
...
agentPlanned.honestyDeclaration.li.crime.lpp = because my client was affected by a crime, they were unable to make the payment due on {0} (Welsh)
...
agentPlanned.honestyDeclaration.li.fireandflood.lpp = because my client was affected by a fire or flood, they were unable to make the payment due on {0} (Welsh)
...
agentPlanned.honestyDeclaration.li.health.lpp = because my client had a serious or life-threatening health issue, they were unable to make the payment due on {0} (Welsh)
...
agentPlanned.honestyDeclaration.li.technicalIssue.lpp = because my client was affected by software or technology issues, they were unable to make the payment due on {0} (Welsh)
...
agentPlanned.honestyDeclaration.li.other.lpp = my client was unable to make the payment due on {0} (Welsh)

clientPlanned.honestyDeclaration.li.bereavement.lsp = because my client was affected by someone’s death, they were unable to send the submission due on {0} (Welsh)
clientPlanned.honestyDeclaration.li.cessation.lsp = TBC cessation - they were unable to send the submission due on {0} (Welsh)
clientPlanned.honestyDeclaration.li.crime.lsp = because my client was affected by a crime, they were unable to send the submission due on {0} (Welsh)
clientPlanned.honestyDeclaration.li.fireandflood.lsp = because of a fire or flood, my client was unable to send the submission due on {0} (Welsh)
clientPlanned.honestyDeclaration.li.health.lsp = because my client had a serious or life-threatening health issue, they were unable to send the submission due on {0} (Welsh)
clientPlanned.honestyDeclaration.li.technicalIssue.lsp = because of software or technology issues, my client was unable to send the submission due on {0} (Welsh)
clientPlanned.honestyDeclaration.li.unexpectedHospital.lsp = because my client had an unexpected hospital stay, they were unable to send the submission due on {0} (Welsh)
clientPlanned.honestyDeclaration.li.other.lsp = my client was unable to send the submission due on {0} (Welsh)

agentPlanned.clientAffected.honestyDeclaration.li.bereavement.lsp = because my client was affected by someone’s death, I was unable to send the submission due on {0} (Welsh)
...
agentPlanned.clientAffected.honestyDeclaration.li.crime.lsp = because my client was affected by a crime, I was unable to send the submission due on {0} (Welsh)
agentPlanned.clientAffected.honestyDeclaration.li.fireandflood.lsp = because my client was affected by a fire or flood, I was unable to send the submission due on {0} (Welsh)
agentPlanned.clientAffected.honestyDeclaration.li.health.lsp = because my client had a serious or life-threatening health issue, I was unable to send the submission due on {0} (Welsh)
agentPlanned.clientAffected.honestyDeclaration.li.technicalIssue.lsp = because my client was affected by software or technology issues, I was unable to send the submission due on {0} (Welsh)
agentPlanned.clientAffected.honestyDeclaration.li.unexpectedHospital.lsp = because my client had an unexpected hospital stay, I was unable to send the submission due on {0} (Welsh)
agentPlanned.clientAffected.honestyDeclaration.li.other.lsp = because of an issue affecting my client, I was unable to send the submission due on  {0} (Welsh)

agentPlanned.agentAffected.honestyDeclaration.li.bereavement.lsp = because I was affected by someone’s death, I was unable to send the submission due on {0} (Welsh)
...
agentPlanned.agentAffected.honestyDeclaration.li.crime.lsp = because I was affected by a crime, I was unable to send the submission due on {0} (Welsh)
agentPlanned.agentAffected.honestyDeclaration.li.fireandflood.lsp = because of a fire or flood, I was unable to send the submission due on {0} (Welsh)
...
agentPlanned.agentAffected.honestyDeclaration.li.technicalIssue.lsp = because of software or technology issues, I was unable to send the submission due on {0} (Welsh)
...
agentPlanned.agentAffected.honestyDeclaration.li.other.lsp = I was unable to send the submission due on {0} (Welsh)

honestyDeclaration.li.lpp = no one else was available to make the payment for me (Welsh)
agent.honestyDeclaration.li.lpp = no one else was available to make the payment for them (Welsh)
...
checkYourAnswers.whenDidEventHappen.health.key = When did the health issue first stop you making the payment? (Welsh)
