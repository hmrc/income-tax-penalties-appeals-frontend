...
import uk.gov.hmrc.incometaxpenaltiesappealsfrontend.controllers.auth.models.AuthorisedUserRequest
import uk.gov.hmrc.incometaxpenaltiesappealsfrontend.utils.EnrolmentUtil.AuthReferenceExtractor
