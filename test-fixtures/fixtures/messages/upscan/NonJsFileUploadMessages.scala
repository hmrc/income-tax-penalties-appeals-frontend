...
object NonJsFileUploadMessages {
  ...
  sealed trait Messages { this: i18n =>
    ...
    val p2lspAgent = "Upload evidence that explains why your client missed the submission deadline, such as a letter or email."
  ...
  object Welsh extends Messages with Cy {
    ...
    override val p2LSP = "Upload evidence that explains why you missed the submission deadline, such as a letter or email.(WELSH)"
    override val p2LSPReview = "Upload evidence that explains why you missed the submission deadline, such as a letter or email.(WELSH)"
    override val p2lspAgent = "Uwchlwythwch dystiolaeth, fel llythyr neu e-bost, yn egluro pam y gwnaeth eich cleient methu’r dyddiad cau."
    override val heading3 = "Files you can upload(WELSH)"
    ...
    override val p2LPPAgent = "Upload evidence that explains why your client missed the payment deadline, such as a letter or email(WELSH)"
