...
object NonJsFileUploadMessages {
  ...
  sealed trait Messages { _: i18n =>
    ...
    val p2LSPReview = "Evidence might include any documents or letters that show why the submission deadline was missed."
  ...
  object Welsh extends Messages with Cy {
    ...
    override val p2LSPReview = "Evidence might include any documents or letters that show why the submission deadline was missed. (Welsh)"
