...
//LSP
    "the page has the correct elements for first stage appeals" when {
      "the user is an authorised individual" in {
        ...
        document.getElementById("confirmationSecondParagraph").text() shouldBe "This appeal has been logged against the National Insurance number [nino]. Quote this number if contacting HMRC about this appeal."
...
///LPP Review/Second stage (single)
    "the page has the correct elements for second stage appeal payment penalty (single)" when {
      "the user is an authorised individual" in {
        ...
        document.getElementsByClass("govuk-panel__body").text() shouldBe "First late payment penalty: 1 January 2024 to 31 January 2024"
        document.getElementById("confirmationFistParagraph").text() shouldBe "You do not need a reference number."
        document.getElementById("confirmationSecondParagraph").text() shouldBe "This request for a review has been logged against the National Insurance number [nino]. Quote this number if contacting HMRC about this appeal."
