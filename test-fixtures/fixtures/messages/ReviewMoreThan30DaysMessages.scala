...
object ReviewMoreThan30DaysMessages {
  ...
  sealed trait Messages { this: i18n =>
    ...
    val errorRequired = "Select yes if it has been more than 30 days since the appeal decision was issued"
    val errorInvalid = "Select yes if it has been more than 30 days since the appeal decision was issued"
    ...
    val cyaHidden = "whether it is more than 30 days since the appeal decision"
  }
  ...
  object Welsh extends Messages with Cy {
    ...
    override val errorRequired = "Nodwch ‘Iawn’ os yw mwy na 30 diwrnod wedi mynd heibio ers cyhoeddi penderfyniad yr apêl"
    override val errorInvalid = "Nodwch ‘Iawn’ os yw mwy na 30 diwrnod wedi mynd heibio ers cyhoeddi penderfyniad yr apêl"
    ...
    override val cyaHidden = "a yw’n fwy na 30 diwrnod ers penderfyniad yr apêl"
  }
}
