...
object HonestyDeclarationMessages extends BaseFixtures {
  ...
  sealed trait Messages { _: i18n =>
    ...
    val agentBereavementMessageLPP: String = "because my client was affected by someone’s death, they were unable to make the payment due on 1 January 2022"
    val agentCessationMessageLPP: String = "TBC cessation - they were unable to make the payment due on 1 January 2022"
    val agentCrimeMessageLPP: String = "because my client was affected by a crime, they were unable to make the payment due on 1 January 2022"
    ...
    val agentTechnicalIssueMessageLPP: String = "because my client was affected by software or technology issues, they were unable to make the payment due on1 January 2022"
    ...
    val clientPlannedCessationMessageLSP: String = "TBC cessation - they were unable to send the submission due on 1 January 2022"
    val clientPlannedCrimeMessageLSP: String = "because my client was affected by a crime, they were unable to send the submission due on"
    val clientPlannedFireOrFloodReasonMessageLSP: String = "because of a fire or flood, my client was unable to send the submission due on 1 January 2022"
    val clientPlannedHealthMessageLSP: String = "because my client had a serious or life-threatening health issue, they were unable to send the submission due on 1 January 2022"
    val clientPlannedTechnicalIssueMessageLSP: String = "because of software or technology issues, my client was unable to send the submission due on 1 January 2022"
    val clientPlannedUnexpectedHospitalMessageLSP: String = "because my client had an unexpected hospital stay, they were unable to send the submission due on 1 January 2022"
    val clientPlannedOtherMessageLSP: String = "my client was unable to send the submission due on 1 January 2022"
    
    val agentPlannedClientAffectedBereavementMessageLSP: String = "because my client was affected by someone’s death, I was unable to send the submission due on 1 January 2022"
    val agentPlannedClientAffectedCessationMessageLSP: String = "TBC cessation - I was unable to send the submission due on 1 January 2022"
    val agentPlannedClientAffectedCrimeMessageLSP: String = "because my client was affected by a crime, I was unable to send the submission due on 1 January 2022"
    val agentPlannedClientAffectedFireOrFloodReasonMessageLSP: String = "because my client was affected by a fire or flood, I was unable to send the submission due on 1 January 2022"
    val agentPlannedClientAffectedHealthMessageLSP: String = "because my client had a serious or life-threatening health issue, I was unable to send the submission due on 1 January 2022"
    val agentPlannedClientAffectedTechnicalIssueMessageLSP: String = "because my client was affected by software or technology issues, I was unable to send the submission due on 1 January 2022"
    val agentPlannedClientAffectedUnexpectedHospitalMessageLSP: String = "because my client had an unexpected hospital stay, I was unable to send the submission due on 1 January 2022"
    val agentPlannedClientAffectedOtherMessageLSP: String = "because of an issue affecting my client, I was unable to send the submission due on 1 January 2022"
    
    val agentPlannedAgentAffectedBereavementMessageLSP: String = "because I was affected by someone’s death, I was unable to send the submission due on 1 January 2022"
  ...
  object Welsh extends Messages with Cy {
    ...
    override val agentBereavementMessageLPP: String = "because my client was affected by someone’s death, they were unable to make the payment due on 1 January 2022 (Welsh)"
    override val agentCessationMessageLPP: String = "TBC cessation - they were unable to make the payment due on 1 January 2022 (Welsh)"
    override val agentCrimeMessageLPP: String = "because my client was affected by a crime, they were unable to make the payment due on 1 January 2022 (Welsh)"
    ...
    override val clientPlannedCessationMessageLSP: String = "TBC cessation - they were unable to send the submission due on 1 January 2022 (Welsh)"
    override val clientPlannedCrimeMessageLSP: String = "because my client was affected by a crime, they were unable to send the submission due on (Welsh)"
    ...
    override val agentPlannedClientAffectedCessationMessageLSP: String = "TBC cessation - I was unable to send the submission due on 1 January 2022 (Welsh)"
    override val agentPlannedClientAffectedCrimeMessageLSP: String = "because my client was affected by a crime, I was unable to send the submission due on 1 January 2022 (Welsh)"
